	...
	return (
		<div className="report-detail-style">
			<div className='user-head'>
				<Avatar size="large" src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8dXNlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60" />
			...
			<div className='info-section'>
				<Row>
					...
					<Col sm={12}>
						<div className='info-box'>
							<h4 className='title4'>Quizes Taken</h4>
							<p className='description'>20</p>
						</div>
					</Col>
					<Col sm={12}>
						<div className='info-box'>
							<h4 className='title4'>Quizes Skipped</h4>
